...
test.describe('Checking the name, description and price of the product on the checkout page', () => {
    ...
    test('Checking the product name on the checkout page', async ({ checkoutPage }) => {
    ...
    test('Checking the product description on the checkout page', async ({ checkoutPage }) => {
    ...
    test('Checking the product prices on the checkout page', async ({ checkoutPage }) => {
